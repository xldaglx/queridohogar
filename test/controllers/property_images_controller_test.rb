...
class PropertyImagesControllerTest < ActionController::TestCase
  ...
  test "should create property_image" do
    assert_difference('PropertyImage.count') do
      post :create, property_image: { image: @property_image.image, position: @property_image.position, property_id: @property_image.property_id }
    end
  ...
  test "should update property_image" do
    patch :update, id: @property_image, property_image: { image: @property_image.image, position: @property_image.position, property_id: @property_image.property_id }
    assert_redirected_to property_image_path(assigns(:property_image))
  end
